...
@Slf4j
@Component
public class MapperHandler extends AbstractGeneratorHandler implements GeneratorHandler {
    ...
    public void handler(Table table) throws Exception {
        log.info("开始生成{}Mapper", table.getEntityName());
        ...
        log.info("生成{}Mapper成功", table.getEntityName());
    }
